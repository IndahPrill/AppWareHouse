...
--
-- Host: 127.0.0.1:3374
-- Generation Time: Feb 05, 2023 at 12:39 PM
...
(2, 'REQ2302050001', 'STO2302050008', 'BRG020405', 'Tiang', '10', '10', '-', '-', 2, 0, 2, 0, '0', '0');
...
(3, 3, 'STO2302050002', 'BRG010103', 'Kursi Minimalis Cafe', '', '', '', '', 5, '0', '2023-02-07 03:47:02', NULL, NULL, NULL),
...
(10, 1, 'STO2302050005', 'BRG010205', 'Meja Bufet Klasik T', '', '', '', '', 5, '0', '2023-02-14 03:47:02', NULL, NULL, NULL),
...
(16, 1, 'STO2302050008', 'BRG010401', 'R Sepatu ', '', '', '', '', 5, '0', '2023-02-20 03:47:02', NULL, NULL, NULL),
...
(26, 2, 'STO2302050013', 'BRG020101', 'Papan ', '300', '20', '', '', 5, '0', '2023-03-02 03:47:02', NULL, NULL, NULL),
...
(45, 3, 'STO2302050008', 'BRG020405', 'Tiang', '10', '10', '', '', 5, '0', '2023-03-21 03:47:02', NULL, NULL, NULL),
...
(3, 'gudang', 'a80dd043eb5b682b4148b9fc2b0feabb2c606fff', 'Karl', 2, 0, '2023-02-05 02:38:27', 0),
(5, 'produksi', '6e3bf9569d685dc740285417951b943b2452c2b5', 'Steve Handjob', 3, 0, '2023-02-05 01:02:54', 0);
...
--
ALTER TABLE `activity_log_barang`
  MODIFY `id_log_barang` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `activity_log_req`
--
ALTER TABLE `activity_log_req`
  MODIFY `id_log_req` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `d_request`
--
ALTER TABLE `d_request`
  MODIFY `id_dtl_req` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `m_request`
  MODIFY `id_m_req` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
