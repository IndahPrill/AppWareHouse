...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 04, 2023 at 07:12 PM
...
INSERT INTO `d_request` (`id_dtl_req`, `kd_req`, `kd_barang`, `nama_brg`, `length_size`, `width_size`, `lumber_type`, `species_type`, `qty_tot`, `qty_confir`, `qty_req`, `qty_cancel`, `status_req`, `is_active`) VALUES
(23, 'REQ2302020001', 'BRG010101', 'Kursi Ukir Jepara', '-', '-', '-', 'Jati Emas', 12, 5, 7, 0, '1', '0'),
(24, 'REQ2302020001', 'BRG010102', 'Sofa', '-', '-', '-', 'Kayu Mahogani', 5, 1, 4, 0, '1', '0'),
(25, 'REQ2302020001', 'BRG010202', 'Meja minimalist square', '-', '-', '-', 'Kayu Mahogani', 2, 0, 2, 0, '0', '0');
...
INSERT INTO `m_barang` (`id_brg`, `kode`, `sub_kode`, `sub_data`, `name`, `length_size`, `width_size`, `lumber_type`, `species_type`, `is_active`, `created_at`, `created_by`) VALUES
...
(15, 'REQ2302020001', '2023-07-02 02:20:16', 2, 19, '0', '2023-02-02 02:20:16', 'Steve Handjob');
...
INSERT INTO `m_stock` (`id_stock`, `supplier_id`, `kd_req`, `kd_barang`, `nama_brg`, `length_size`, `width_size`, `lumber_type`, `species_type`, `qty`, `is_active`, `created_at`, `created_by`, `update_at`, `update_by`) VALUES
(2, 2, 'REQ2302020001', 'BRG010101', '', '-', '-', '-', 'Jati Emas', 2, '0', '2023-02-03 06:56:44', NULL, NULL, NULL),
(3, 2, 'REQ2302020001', 'BRG010101', '', '-', '-', '-', 'Jati Emas', 3, '0', '2023-02-03 06:58:10', NULL, NULL, NULL),
(4, 2, 'REQ2302020001', 'BRG010102', '', '-', '-', '-', '-', 1, '0', '2023-02-03 06:59:08', NULL, NULL, NULL);
...
--
-- Dumping data for table `tem_req`
--

INSERT INTO `tem_req` (`id_tem_req`, `kd_req`, `kd_barang`, `name`, `length_size`, `width_size`, `lumber_type`, `species_type`, `qty`) VALUES
(6, 'REQ2302030001', 'BRG010204', '', '-', '-', '-', '-', 4),
(7, 'REQ2302030001', 'BRG010103', '', '-', '-', '-', '-', 4),
(8, 'REQ2302030001', 'BRG010102', '', '-', '-', '-', '-', 4);
...
(1, 'admin', 'd033e22ae348aeb5660fc2140aec35850c4da997', 'Vincent', 1, 0, '2023-02-03 13:01:56', 1),
(3, 'gudang', 'a80dd043eb5b682b4148b9fc2b0feabb2c606fff', 'Karl', 2, 0, '2023-02-04 22:47:29', 1),
(5, 'produksi', '6e3bf9569d685dc740285417951b943b2452c2b5', 'Steve Handjob', 3, 0, '2023-02-03 12:23:04', 0);
...
--
ALTER TABLE `activity_log_req`
  MODIFY `id_log_req` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=301;

--
-- AUTO_INCREMENT for table `d_request`
--
ALTER TABLE `d_request`
  MODIFY `id_dtl_req` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
--
ALTER TABLE `m_request`
  MODIFY `id_m_req` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `tem_req`
  MODIFY `id_tem_req` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
