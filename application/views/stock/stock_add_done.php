<div class="wrapper">
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                Item Add
                <small>Tambah Barang Jadi</small>
            </h1>
            <ol class="breadcrumb">
                    ...
                    <div class="box box-primary">
                        ...
                        <form id="formBarang" method="post">
                            ...
                            <div class="box-footer">
                                <button type="submit" class="btn btn-primary" id="tmbDataDone"><i class="fa fa-plus"></i>&nbsp;&nbsp;Tambah</button>
                            </div>
                        </form>
                    </div>
                </div>
		...
		$("#formBarang").validate({
			...
			submitHandler: function(form) {
				...
				$.ajax({
					...
					url: "<?= site_url('Stock/sto/postItems') ?>",
					dataType: "JSON",
